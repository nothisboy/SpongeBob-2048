    ...
    private class Builder {
        ...
        private Builder() {
            ...
            mButtonLayout = (LinearLayout) mAlertDialogWindow.findViewById(
                    R.id.buttonLayout);
            mPositiveButton = (TextView) mButtonLayout.findViewById(R.id.btn_p);
            mNegativeButton = (TextView) mButtonLayout.findViewById(R.id.btn_n);
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setPadding(dip2px(0), 0, dip2px(16), dip2px(BUTTON_BOTTOM));
        ...
        public void setNegativeButton(String text, final View.OnClickListener listener) {
            ...
            if (mButtonLayout.getChildCount() > 0) {
                params.setMargins(0, 0, 0, dip2px(BUTTON_BOTTOM));
                button.setLayoutParams(params);
